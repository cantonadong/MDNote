<script lang="ts">
  ...
  const paths: Record<string, string> = {
    ...
    highlighter: "M9 11 3 17v3h9l3-3 M22 12l-4.6 4.6a2 2 0 0 1-2.8 0l-5.2-5.2a2 2 0 0 1 0-2.8L14 4Z",
    ...
    pin: "M12 17v5 M7 3h10 M15 3l1 7 3 3H5l3-3 1-7",
  };
</script>
...
>
  ...
  {:else if name === "wavy-underline"}
    <path d="M6 4v7a5 5 0 0 0 10 0V4" />
    <path d="M4 19.5c1.2-1.5 2.4-1.5 3.6 0s2.4 1.5 3.6 0 2.4-1.5 3.6 0 2.4 1.5 3.6 0" stroke-width="1.6" />
